  ...
  <div class="container wrapper-navigation ">
    ...
    <div class="navbar-header">
      ...
      <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#topmenu">
       ...
       <a class="navbar-brand" href="{{ URL::to('')}}"> <img src="{{asset('sximo/images/logo-alt.png')}}" style="width:100%;"  align="absmiddle"/></a>
    </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 col-sm-4">
					<p><i class="icon-location3"></i></p>
					<h3> FIND US </h3>
					<p>120002 Loki — UNITED KINGDOM </p>
				</div>

				<div class="col-md-4 col-sm-4">
					<p><i class="icon-mail4"></i></p>
					<h3> MAIL US </h3>
					<p>info@example.com</p>
				</div>
				
				<div class="col-md-4 col-sm-4">
					<p><i class="icon-man"></i></p>
					<h3> JOIN US </h3>
					<p>Send your resume to
recruit@example.com</p>
				</div>				
