...
<div class="page-content">
    ...
    <div class="row cust-round">
       <div class="col-sm-12">
        <div class="panel panel-default">
            <div class="panel-body viewedit-search-panel">
               <div class="row row-1">
                <div class="col-sm-12">
                    <div class="col-sm-2">
                        <label class="control-label">{{ $RoundData[0]->round_name }}</label> (<label class="control-label">{{ $RoundData[0]->round_number }}</label>)
                    </div>
                    <div class="col-sm-2">
                        <label class="control-label">{{ $RoundData[0]->staff_name }}</label> <label class="control-label">{{ $RoundData[0]->staff_number }}</label>
                    </div>
                </div>
               </div>

                <div class="row row-2" style="margin:0px;padding:0px;">
                    <div class="col-sm-12">
                        <!--<div class="col-sm-2">
                ...
                <div>
                    <fieldset class="col-md-12" style="padding: 0px;">
                        <div class="panel panel-default">
                            <div class="panel-body viewedit-search-panel search-cust"  style="background-color: #fff;">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
	...
	<div class="row clearfix inline-block div-cust-button" >
		<div class="col-sm-2  cust-button">
			{{ Form::button('Customer Main', array('class' => 'cust_btn btn', 'data-butt' => 'Customermain')); }}
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Customer Details', array('class' => 'cust_btn btn ', 'data-butt' => 'Customerdetails')); }}
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Customer Relative', array('class' => 'cust_btn btn', 'data-butt' => 'Customerrelative')); }}		
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Income/Outgoing', array('class' => 'cust_btn btn', 'data-butt' => 'incomeexpenditure')); }}		
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Comments', array('class' => 'cust_btn btn', 'data-butt' => 'Customercomments')); }}		
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Account history', array('class' => 'cust_btn btn', 'data-butt' => 'Accounthistory')); }}		
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Accounts', array('class' => 'cust_btn btn', 'data-butt' => 'Customeraccounts')); }}		
		</div>
		<div class="col-sm-2 cust-button">
			{{ Form::button('Payment Log', array('class' => 'cust_btn btn', 'data-butt' => 'Paymenttranlog')); }}		
		</div>
		<!--<div class="col-sm-2 cust-button">
			{{ Form::button('Assign to call back', array('class' => 'btn', 'data-butt' => 'assign_call', 'onclick' => 'open_model();')); }}		
		</div>-->
	</div>
...
<!-- Reassign Call Back Day Model for the day selection.-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="callback_timeSelect_Reassign" class="form-control" placeholder="12:00" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">Call Back Time:</label>
                                <input type="text" id="callback_timeSelect" class="form-control" placeholder="12:00">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
		...
		$('.cust_btn').on('click', function() {
            ...
            {
                customer_no = $('input[name="insertedcustomers"]:checked').val();
				page = $(this).data('butt');
				go_selected_customer(page);
            }else{
        ...
        function go_selected_customer(cust_page = '')
        {
            if($('input[name="insertedcustomers"]:checked').length > 0 || $('input[name="selectcallbacklist"]:checked').length > 0)
            {
                ...
                $.ajax({
                    ...
                    type:"POST",
                    data:{"relation_id":cust_no, "_token": "{{csrf_token()}}", "formtype": cust_page},
                    success: function(result){
                        var obj = JSON.parse(result);
						console.log(cust_page);
						if(cust_page === "Customermain" || cust_page === "Customerdetails" || cust_page === "incomeexpenditure"|| cust_page === "Customerrelative")
						{
							window.location='/' + cust_page + '/add/'+obj.formID+'?flag=adminround&round_number='+round_number;							
						}
						else
						{
							window.location='/' + cust_page + '?search=customer_no:'+obj.cust_no+'&flag=adminround&round_number='+round_number;
						}
                    }
                });
            }else{
