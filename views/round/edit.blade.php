...
<div class="page-content">
    ...
    <div class="panel-default panel">
        <div class="panel-body">
            ...
            {{ Form::open(array('url'=>'/update_round/'.$round[0]->round_number, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
            <div class="col-md-12">
                <fieldset><legend> Add Round</legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="round_number" class="form-control" value="{{ $round[0]->round_number }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="round_name" class="form-control" value="{{ $round[0]->round_name }}" disabled>
                        </div>
                    </div>
                    <div class="form-group">
