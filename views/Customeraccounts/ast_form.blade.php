				...
				<div class="col-md-12">
					...
					<div style="height: 20px;" ></div>
						<fieldset><legend> Add/Edit Customer Accounts</legend>
                            ...
                            class='select2 '  >
                                        <option value="Auto " <?php if($row->payment_type == "Auto") echo 'selected="selected"';?>>Auto Payment</option>
                                        <option value="Cash " <?php if($row->payment_type == "Cash") echo 'selected="selected"';?>>Cash Payment</option> 
										</select>
									 </div> 
								  </div> 
								  ...
								  <div class="form-group  " >
									...
									@if( !empty($row['last_payment_made']) && $row['last_payment_made'] != '0000-00-00' && $row['last_payment_made'] != '1970-01-01'  )
										{{ Form::text('last_payment_made', date('d/m/Y', strtotime($row['last_payment_made'])),array('class'=>'form-control', 'placeholder'=>''   )) }} 									
									@else
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
										@if( !empty($row['loan_start_date']) )
									  	...
									  	@else
									  		{{ Form::text('loan_start_date', date('d/m/Y'),array('class'=>'form-control datepicker', 'placeholder'=>'' )) }}
									  	@endif
									 </div> 
								  </div> 					
								  <div class="form-group  " >
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  		{{ Form::text('first_payment', date('d/m/Y', strtotime($row['first_payment'])),array('class'=>'form-control datepicker', 'placeholder'=>'' )) }} 
									 </div> 
								  </div> 					
								  <div class="form-group  " >
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  {{ Form::text('next_payment_due_date', date('d/m/Y', strtotime($row['next_payment_due_date'])),array('class'=>'form-control datepicker', 'placeholder'=>''   )) }} 
									 </div> 
								  </div> 													  
								  <div class="form-group  " >
							...
							class='select2' {{ (!empty($row['t_and_c']) ? 'disabled="disabled"' : '') }} ></select>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
										@if( !empty($row['week_no']) || $row['week_no'] == 0 )
									  		{{ Form::text('week_no', ( !empty($row['week_no']) ? $row['week_no'] : 0 ),array('class'=>'form-control', 'placeholder'=>'' )) }}
									  	@else
								  ...
								  <div class="form-group  " >
									<label for="Reason for loan" class=" control-label col-md-4 text-left {{ (!empty($row['reason_for_loan']) ? '' : '') }}"> Reason for Loan </label>
									<div class="col-md-8">
							...
							class='select2 '    ></select> 
								  ...
								  <div class="form-group div_loan_status_reduced " style='display:none;' >
									...
									<div class="col-md-8">
										{{ Form::textarea('loan_status_reduced_desc', $row['loan_status_reduced_desc'],array('class'=>'form-control', 'placeholder'=>'',   )) }} 
									 </div> 
								  </div>								  
								  </fieldset>
			</div>
