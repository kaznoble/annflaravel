						...
						<fieldset><legend> Add/Edit Customer Accounts</legend>
							...
							class='select2' {{ (!empty($row['t_and_c']) ? 'disabled="disabled"' : '') }} ></select>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
									  {{ Form::text('no_miss_payment', (!empty($row['no_miss_payment']) ? $row['no_miss_payment'] : '0'),array('class'=>'form-control', 'placeholder'=>''   )) }} 
									 </div> 
								  </div> 				
								  <div class="form-group  " >
									<label for="Arrears" class=" control-label col-md-4 text-left"> Arrears </label>
									<div class="col-md-8">
									  {{ Form::text('arrears', (!empty($row['arrears']) ? $row['arrears'] : '0'),array('class'=>'form-control', 'placeholder'=>''   )) }} 
									 </div> 
								  </div> 									  	
								  <!--<div class="form-group  " >
