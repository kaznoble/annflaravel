  ...
  <div class="page-content">
    ...
    <div class="breadcrumb-line">
	  ...
	  <ul class="breadcrumb-buttons collapse">
			...
			<li><a href="{{ URL::to('Cashonlypayments/download') }}" class="tips" title="{{ Lang::get('core.btn_download') }}">
			<i class="icon-folder-download2"></i>&nbsp; </a></li>	
			@endif		
		 	@if(Session::get('gid') ==1)
			<li><a href="{{ URL::to('module/config/Cashonlypayments') }}" class="tips"  title="{{ Lang::get('core.btn_config') }}">
			<i class="icon-cog"></i>&nbsp; </a></li>	
			@endif  
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('Cashonlypayments/add') }}" class="tips"  title="{{ Lang::get('core.btn_create') }}">
	...
	<div class="table-responsive">
	 {{ Form::open(array('url'=>'Cashonlypayments/destroy/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) }}
        ...
        <tbody>
			<tr id="sximo-quick-search" >
				...
				@foreach ($tableGrid as $t)
					...
					<td>
					@if( $t['field'] == 'forename' )
							<input class="form-control input-sm" type="text" value="" name="forename" placeholder="first name" >
					@elseif( $t['field'] == 'surname' )
							<input class="form-control input-sm" type="text" value="" name="surname" placeholder="surname" >						
					@else							
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 @foreach ($tableGrid as $field)
					 ...
					 <td>					 
						...
						@else	
							...
							@if( $field['field'] == 'next_payment_due_date' )
				 ...
				 <td>
					...
					<a href="{{ URL::to('Cashonlypayments/show/'.$id)}}"  class="tips btn btn-xs btn-default"  title="{{ Lang::get('core.btn_view') }}"><i class="icon-paragraph-justify"></i> </a>
					@endif
					@if($access['is_edit'] ==1)
					<a  href="{{ URL::to('Cashonlypayments/add/'.$id)}}"  class="tips btn btn-xs btn-success"  title="{{ Lang::get('core.btn_edit') }}"> <i class="icon-pencil4"></i></a>
					@endif
				...
				@include('Cashonlypayments.inlineview')
            @endforeach
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','{{ URL::to("Cashonlypayments/multisearch")}}');
		$('#SximoTable').submit();
	});
