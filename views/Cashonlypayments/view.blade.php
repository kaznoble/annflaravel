    ...
    <div class="breadcrumb-line">
 	...
 	<div class="visible-xs breadcrumb-toggle">
	   ...
	   <ul class="breadcrumb-buttons collapse">
	   		<li><a href="{{ URL::to('Cashonlypayments') }}" class="tips" title="{{ Lang::get('core.btn_back') }}"><i class="icon-table"></i>&nbsp;</a></li>
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('Cashonlypayments/add/'.$id) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="icon-pencil3"></i>&nbsp;</a></li>
			@endif  
	...
	<table class="table table-striped table-bordered" >
		<tbody>	
					...
					<tr>
						...
						<td>{{ date("d/m/Y", strtotime($row->next_payment_due_date)) }}</td>
