  ...
  <div class="page-content">
    ...
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('loanapphistory') }}">{{ $pageTitle }}</a></li>
	...
	<div class="panel-default panel">
		...
		<ul class="parsley-error-list">
		 ...
		 {{ Form::open(array('url'=>'loanapphistory/save/'.SiteHelpers::encryptID($row['app_primary_id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
				<div class="col-md-12">
						<fieldset><legend> loanapphistory</legend>
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
										{{ Form::select('title',   (['1'=>'Mr','2'=>'Mrs','3'=>'Miss','4'=>'Ms','5'=>'Dr','6'=>'Professor']), isset($row['title'])?$row['title']:null, ['class' => 'form-control', 'tabindex' => 2]) }}
									 </div> 
								  </div> 					
								  <div class="form-group  " >
				...
				{{ Form::text('created_date', $row['created_date'],array('class'=>'form-control date', 'style'=>'width:150px !important;')) }} 
									 </div> 
								  </div> 					
								  <div class="form-group  " >
				...
				{{ Form::text('timestamp', $row['timestamp'],array('class'=>'form-control datetime', 'style'=>'width:150px !important;')) }} 
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
										{{ Form::select('successful_applicant', (['0'=>'No','1'=>'Yes']),$row['successful_applicant'], ['class' => 'form-control']) }}
									 </div> 
								  </div> 					
								  <div class="form-group  " >
								  ...
								  <div class="form-group  " >
									...
									<div class="col-md-8">
										{{ Form::select('processed', (['0'=>'No','1'=>'Yes']),$row['processed'], ['class' => 'form-control']) }}
									 </div> 
								  </div> 					
								  <div class="form-group  " >
									<label for="Admin View" class=" control-label col-md-4 text-left"> Admin View </label>
									<div class="col-md-8">
										{{ Form::select('admin_view', (['1'=>'Yes','0'=>'No']),$row['admin_view'], ['class' => 'form-control']) }}
									 </div> 
								  </div> 					
								  <div class="form-group  " >
								  ...
								  <div class="form-group  " >
									<label for="Long" class=" control-label col-md-4 text-left"> Long </label>
									<div class="col-md-8">
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('loanapphistory') }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  
