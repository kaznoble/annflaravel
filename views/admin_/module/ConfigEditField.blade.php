...
<div class="" style="padding:30px;">			
  ...
  <div class="form-group standart-form database" style="display:none;">
	...
	<div class="col-md-8">
		...
		<label class="checkbox">
		<input type="checkbox" name="is_multiple" class="ext" value="1" <?php if(isset($f['option']['is_multiple']) && $f['option']['is_multiple'] =='true') echo 'checked="checked"';?>  /> Allow Multiple
		</label>
		<label class="checkbox">
