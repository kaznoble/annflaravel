...
@endif
 ...
 <div class="infobox infobox-info fade in">
  ...
  <p> <strong>Note !</strong> Define lable , form type ,validation and searchable </p>	
</div> 
 ...
 <div class="table-responsive">
		...
		<thead class="no-border">
          ...
          <tr>
            ...
            <td><input type="text" name="label[<?php echo $id;?>]" class="form-control input-sm" value="<?php echo $rows['label'];?>" />           </td>
			<td>
            <?php echo $rows['type'];?>
