  ...
  <div class="page-content">
    ...
    <div class="breadcrumb-line">
	  ...
	  <ul class="breadcrumb-buttons collapse">
			...
			<li><a href="{{ URL::to('incomeexpenditure/download') }}" class="tips" title="{{ Lang::get('core.btn_download') }}">
			<i class="icon-folder-download2"></i>&nbsp; </a></li>	
			@endif		
		 	@if(Session::get('gid') ==1)
			<li><a href="{{ URL::to('module/config/incomeexpenditure') }}" class="tips"  title="{{ Lang::get('core.btn_config') }}">
			<i class="icon-cog"></i>&nbsp; </a></li>	
			@endif  
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('incomeexpenditure/add') }}" class="tips"  title="{{ Lang::get('core.btn_create') }}">
...
@if(Session::has('success'))
	...
	<div class="table-responsive">
	 {{ Form::open(array('url'=>'incomeexpenditure/destroy/', 'class'=>'form-horizontal' ,'id' =>'SximoTable' )) }}
        ...
        <thead>
			...
			<tr id="sximo-quick-search" >
				...
				@foreach ($tableGrid as $t)
					@if($t['view'] =='1' && ($t['label'] == 'Outgoing Total' || $t['label'] == 'Income Total'))
					<td>						
            ...
            @foreach ($rowData as $row)
                <tr>
				 ...
				 @foreach ($tableGrid as $field)
					 @if($field['view'] =='1' && ($field['field'] == 'outgoing_total' || $field['field'] == 'income_total'))
					 <td>					 
				 ...
				 <td>
					...
					<a href="{{ URL::to('incomeexpenditure/show/'.$id)}}"  class="tips btn btn-xs btn-default"  title="{{ Lang::get('core.btn_view') }}"><i class="icon-paragraph-justify"></i> </a>
					@endif
					@if($access['is_edit'] ==1)
					<a  href="{{ URL::to('incomeexpenditure/add/'.$id)}}"  class="tips btn btn-xs btn-success"  title="{{ Lang::get('core.btn_edit') }}"> <i class="icon-pencil4"></i></a>
					@endif
				...
				@include('incomeexpenditure.inlineview')
            @endforeach
...
$(document).ready(function(){
	...
	$('.do-quick-search').click(function(){
		$('#SximoTable').attr('action','{{ URL::to("incomeexpenditure/multisearch")}}');
		$('#SximoTable').submit();
	});
