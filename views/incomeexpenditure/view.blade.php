<div class="page-content">
    ...
    <div class="breadcrumb-line">
 	...
 	<div class="visible-xs breadcrumb-toggle">
	   ...
	   <ul class="breadcrumb-buttons collapse">
	   		<li><a href="{{ URL::to('incomeexpenditure') }}" class="tips" title="{{ Lang::get('core.btn_back') }}"><i class="icon-table"></i>&nbsp;</a></li>
			@if($access['is_add'] ==1)
	   		<li><a href="{{ URL::to('incomeexpenditure/add/'.$id) }}" class="tips" title="{{ Lang::get('core.btn_edit') }}"><i class="icon-pencil3"></i>&nbsp;</a></li>
			@endif  
	...
	<table class="table table-striped table-bordered" >
		<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>Cust Outg Id</td>
						<td>{{ $row->cust_outg_id }} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>Cust Income Id</td>
						<td>{{ $row->cust_income_id }} </td>
					...
					<tr>
						...
						<td>{{ $row->income_frequency }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Wage 1</td>
						<td>{{ $row->wage_1 }} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>Wage 2</td>
						<td>{{ $row->wage_2 }} </td>
